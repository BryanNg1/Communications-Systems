...
Hx=ylabel('s(t)  (Volt)');
set(Hx,'FontWeight','bold','Fontsize',16)
title('modulated wave : Time domain Bryan Ng 400181785 Robert Ek 400202700');
...
Hx=ylabel('|S(f)|');
set(Hx,'FontWeight','bold','Fontsize',16)
title('Spectrum of the modulated wave Bryan Ng 400181785 Robert Ek 400202700');
...
% RC = 1/fc; %for part 2i)
% RC = 10*Tm;
% RC = 0.0006; %RC Values 0.0004-0.0006 are accurate by naked eye
RC = 0.5*(Tm+(1/fc));
%Envelope detector
yt = st;
n=1;
...
Hx=ylabel('y(t)  (Volt)');
set(Hx,'FontWeight','bold','Fontsize',16)
title('After the envelope detector Bryan Ng 400181785 Robert Ek 400202700');
...
Hx=ylabel('y1(t)  (Volt)');
set(Hx,'FontWeight','bold','Fontsize',16)
title('After the DC removal Bryan Ng 400181785 Robert Ek 400202700');
axis([-2e-3 2e-3 min(mt) max(mt)])
%pause
